const regex = /p[\doòóôõö@]+(rr|h)[\daàáâãä@]|p[\doòóôõö@](rr|h)[\S]+nh[\S]|(c|k)[\daáàâãä@]+r[\daáàâãä@]+lh[\S]+|\b(c|k)[\duùúüû]+(\s|\n|$|!|\.|\?)\b|\b(c|k)[\duùúüû]+[sz][\S]+|b[\duùúüûoòóõôö]+(c|s)[\S]+t[\S]+|p[\diìíïî]+(c|k|ck)+[\daàáäâ@]|p[\diìíïî]+r[\doóòöô@]+(c|k)[\S]+|p[\duùúüû#@]+t[\daàáäâãoóòôõôeêéèë@]+[\S]*|(c|k)[\daàáâãä@](c|s)[\deèéêë&]+t[\S]|(c|k)[\daàáâãä@]7|p[\S]+r[\S]+r[\S]+(c|k)[\s\S]{1}|f[\doòóôõöuùúüû@]+d[\S]+r|(x|ch)[\S]+(x|ch)[\S]+t[\S]+|(x|ch)[\doòóôõö@]+t[\daáàãâä@]+|b[\doòóõôö@]+(qu|k)[\S]+t[\S]+|p[\deéèêë&]+n+[\diíìîï]+s|\b[\daàáâãä@]+n+[\daàáâãä@]+(u|l)+\b|[\daàáâãä@]+n+[\duùúûü]+(s|$)|[\doòóôõö@]+t+[\daàáâãä@]+r+[\S]+|b[\S]b[\S](c|K)(\S|$|\s)|pr[\S]+(x|ch)[\S]+(c|k)(\S|$|\s|\n)|p[\duúùûü]+s+y|(x|ch)[\S]+b+[\S]+(c|k)|(x|ch)[\daàáâãä@]+n+[\daàáâãä@]+|b[\doòóôõö@]+g+[\daàáâãä@]+|m[\deèéêë&]+r+d+[\S]+|f[\doóòõôöuúùûü@]+d+[\S]+|f[\duúùüûoòóôöõ@]+ck|d[\diìíîïi]+ck|\bv?tnc\b|\bpqp\b|\bvsf\b|\bkct\b|\bpnc\b|\bfdp\b|\b(c|k)rlh?\b/gi
